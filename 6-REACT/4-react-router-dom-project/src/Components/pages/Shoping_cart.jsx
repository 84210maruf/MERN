...
import { getBasketTotal, getBasketDiscountTotal, getBasketPriceTotal } from '../../reducer';
                      ...
                      <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                        ...
                        <div className="flex items-center justify-around md:order-3 md:justify-end">
                          ...
                          <div className="text-end md:order-4 md:w-32">
                            <p className="text-base font-bold text-gray-900 dark:text-white">Price : $1,499</p>
                          </div>
                        </div>

                        <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                          <a href="#" className="text-base font-medium text-gray-900 hover:underline dark:text-white font-semibold">PC system All in One APPLE iMac (2023)</a>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <dl className="flex items-center justify-between gap-4">
                      ...
                      <dd className="text-sm font-medium text-green-600">{getBasketDiscountTotal(basket)} Tk</dd>
                    </dl>

                    <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                      <dt className="text-[14px] font-semibold  text-gray-500 dark:text-white">SubTotal</dt>
                      <dd className="text-sm font-semibold text-gray-500 dark:text-white">{getBasketTotal(basket)} Tk</dd>
                    </dl>
                  ...
                  <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                    ...
                    <dd className="text-base font-bold text-gray-900 dark:text-white">{
                      getBasketTotal(basket) === 0 ? getBasketTotal(basket) : getBasketTotal(basket) + shipingCost
                    } Taka</dd>
                  </dl>
                </div>

                <Link to={"/payment"} className="animate-bounce flex w-full items-center justify-center rounded-lg px-5 py-2.5 text-md text-sky-50 hover:text-white font-medium bg-gradient-to-tr from-blue-600 to-sky-900 hover: focus:outline-none focus:ring-2 focus:ring-blue-600">Proceed to Checkout</Link>
