        ...
        <footer>
            ...
            <div className="footer bg-sky-200 flex items-center justify-around p-4">
                <aside className="grid-flow-col items-center">
                    ...
                    <p className='tracking-widest text-sky-950'> © {new Date().getFullYear()} MILLENNIAL | All right reserved <br /><span className='tracking-wide text-gray-500 text-[13px]'>Developer (Maruf & Mehedi)</span></p>
                </aside>
