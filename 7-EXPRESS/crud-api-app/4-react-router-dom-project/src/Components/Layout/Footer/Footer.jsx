        ...
        <footer>
            ...
            <div className="hidden footer sm:grid grid-cols-3 justify-items-center  bg-customBg bg-opacity-80 text-md p-6">
                ...
                <nav className=''>
                    ...
                    <Link to={"/category-brand/minasdream"} className="link link-hover">Mina's Dream Collections</Link>
                ...
                <nav className='w-full shadow-sm'>
                    ...
                    <div className="collapse collapse-plus rounded-[3px] bg-sky-50">
                        ...
                        <div className="collapse-content">
                            ...
                            <p><Link to={"/category-brand/minasdream"} className="link link-hover">Mina's Dream Collections</Link></p>
